  ...
  return (
    <button
      className={`relative inline-flex items-center justify-center px-5 py-3 rounded-2xl font-semibold text-charcoal
        ...
        focus:outline-none focus:ring-2 focus:ring-sage/40 overflow-hidden group
        dark:text-white dark:from-pink-600 dark:via-fuchsia-600 dark:to-rose-600 dark:border-white/10 ${className}`}
      {...props}
    >
